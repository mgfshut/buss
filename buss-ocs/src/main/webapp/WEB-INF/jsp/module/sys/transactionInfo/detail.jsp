		...
		<div class="pageFormContent container-fluid" layoutH="68">
			<div class="form-horizontal">
				<div class="panel panel-default">
					...
					<div class="panel-heading">回盘信息</div>
					<div class="panel-body">
						<div class="form-group form-group-sm">
