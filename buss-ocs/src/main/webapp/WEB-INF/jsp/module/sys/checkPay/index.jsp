...
<div class="searchBar container-fluid">
	<div class="row">
		...
		<ul class="nav nav-tabs">
         ...
         <li<c:if test="${!empty(param.contStatus) && param.contStatus == '10'}"> class="active"</c:if>><a href="#qyz" data-toggle="tab" onclick="changeZt('10')">签约中</a></li>
         <li<c:if test="${!empty(param.contStatus) && param.contStatus == '20'}"> class="active"</c:if>><a href="#yqy" data-toggle="tab" onclick="changeZt('20')">已签约</a></li>
         <li<c:if test="${!empty(param.contStatus) && param.contStatus == '30'}"> class="active"</c:if>><a href="#jygb" data-toggle="tab" onclick="changeZt('30')">交易关闭</a></li>
         <li<c:if test="${!empty(param.contStatus) && param.contStatus == '40'}"> class="active"</c:if>><a href="#jyqx" data-toggle="tab" onclick="changeZt('40')">交易取消</a></li>
       </ul>
...
<div id="myTabContent" class="tab-content">
  ...
  <div class="tab-pane fade<c:if test="${!empty(param.contStatus) && param.contStatus == '10'}"> active in</c:if>" id="qyz">
  	<div class="pageContent">
		<div class="panelBar">
				<div class="btn-group" style="margin:4px 5px;">
					<a class="btn btn-primary btn-sm" href="module/sys-checkPay-form/contractInfo-{contractInfoId}"  
  ...
  <div class="tab-pane fade<c:if test="${!empty(param.contStatus) && param.contStatus == '20'}"> active in</c:if>" id="yqy">
  	<div class="pageContent">
		<div class="panelBar">
				<div class="btn-group" style="margin:4px 5px;">
					<a class="btn btn-info btn-sm" href="module/sys-checkPay-detail/contractInfo-{contractInfoId}"  
  ...
  <div class="tab-pane fade<c:if test="${!empty(param.contStatus) && param.contStatus == '30'}"> active in</c:if>" id="jygb">
  	<div class="pageContent">
		<div class="panelBar">
				<div class="btn-group" style="margin:4px 5px;">
					<a class="btn btn-info btn-sm" href="module/sys-checkPay-detail/contractInfo-{contractInfoId}"  
  ...
  <div class="tab-pane fade<c:if test="${!empty(param.contStatus) && param.contStatus == '40'}"> active in</c:if>" id="jyqx">
  	<div class="pageContent">
		<div class="panelBar">
				<div class="btn-group" style="margin:4px 5px;">
					<a class="btn btn-info btn-sm" href="module/sys-checkPay-detail/contractInfo-{contractInfoId}"  
