...
<!-- 分页、搜索表单 -->
<form id="pagerForm" action="module/sys-orderTimeLimit-index/strategy-update"
		...
		<div class="searchBar">
			<table style="align: center;">
				<tr>
					...
					<td align="right"
						style="padding: 1px 2px 1px 200px; line-height: 21px;">原订单时限：</td>
					<td><input type="text" class="textInput" size="10"
						disabled="disabled" value="${value}"></td>
					<td>分钟</td>
					<td align="right"
						style="padding: 1px 2px 1px 20px; line-height: 21px;">新订单时限：</td>
